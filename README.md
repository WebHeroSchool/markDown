# Оглавление.
1. [Строгие проверки на равенство](#строгие-проверки-на-равенство)
2. [Переменные](#переменные)
3. [Функции](#функции)
4. [Условные конструкции](#условные-конструкции)
5. [ES-классы](#ES-классы)
6. [Создание объекта](#создание-объекта)
7. [Отступы](#отступы)
8. [Пробелы](#пробелы)
9. [Скобки](#скобки)
10. [Кавычки](#кавычки)
11. [Точка с запятой](#точка-с-запятой)
